...
//-----------------------------------------------------------------------------
FEWarpFilteredImageConstraint::FEWarpFilteredImageConstraint(FEModel* pfem) : FEWarpConstraint(pfem), m_tmap(m_tmp), m_smap(m_trg)
{
	m_pt = 0.0;
...
//-----------------------------------------------------------------------------
vec3d FEWarpFilteredImageConstraint::wrpForce(FEMaterialPoint& mp)
{
	// evaluate template
...
//-----------------------------------------------------------------------------
mat3ds FEWarpFilteredImageConstraint::wrpStiffness(FEMaterialPoint& mp)
{
	// template value
	double T = m_tmap.value(mp.m_r0);
...
//=====================================================================
BEGIN_FECORE_CLASS(FEWarpSingleFilteredImageConstraint, FEWarpConstraint);
